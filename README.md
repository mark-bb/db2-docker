...
- the following variables are supported only at the moment:
  ...
  - `ADDUSERS=db2user2:1002:passw0rd:db2grp2 db2user4:1004:passw0rd` - Additional users in the form of `user_name:user_id:password:list_of_groups`  separated by space (don't try specify root user or group - they are ignored) created in OS
